...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    var _loop = function _loop(x) {
	        var _loop2 = function _loop2(y) {
	            ...
	            snake.forEach(function (snakeBlock, index) {
	                if ((0, _utils.isEqual)(snakeBlock, [x, y])) {
	                    var block = (0, _snake.getBlock)(snake, index);
	                    cells.push(_react2.default.createElement(_cell2.default, { type: 'snake ' + block }));
	                }
	            });
	            ...
	            switch (cell) {
	                case BLOCK:
	                    break;
	                case APPLE:
	                    cells.push(_react2.default.createElement(_cell2.default, { type: 'apple' }));
	                    break;
	                default:
	                    cells.push(_react2.default.createElement(_cell2.default, { type: 'empty' }));
	            }
	        };
	...
	Grid.propTypes = {
	    grid: _react2.default.PropTypes.array.isRequired,
	    snake: _react2.default.PropTypes.array.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = function Cell(props) {
	    return _react2.default.createElement('div', { className: props.type, style: cellStyle });
	};
	Cell.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getDirection(position, target) {
	    return [UP, RIGHT, DOWN, LEFT].filter(function (move) {
	        return (0, _utils.isEqual)(target, (0, _grid.getAdjacentCell)(move, position));
	    })[0];
	}

	function getBlock(snake, index) {
	    var prevPosition = getDirection(snake[index], snake[index - 1]);
	    var nextPosition = getDirection(snake[index], snake[index + 1]);
	...
	function getBlocks(snake) {
	    return snake.map(function (block, index) {
	        return getBlock(snake, index);
	    });
	}
...
/***/ function(module, exports) {
	...
	var DOWN = 2;
	var LEFT = 3;
	function initializeGrid(_ref, snake, _ref2) {
	...
	function getAdjacentCell(move, _ref5) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	    ...
	    _createClass(Game, [{
	        key: 'init',
	        value: function init() {
	            var _size = _slicedToArray(this.size, 2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getBestMove(moves, scores) {
	    ...
	    scores.forEach(function (score, index) {
	        if (score > 0) {
	            scoresSelected.push({ move: moves[index], score: score });
	        }
	    });
	...
	function getNextMove(game) {
	    ...
	    var _loop = function _loop(tick) {
	        var newMoves = [];
	        var newScores = new Uint8Array([]);
	        moves.forEach(function (move, index) {
	            var newApple = game.apple.slice();
	            var newSnake = game.snake.slice();

	            move.forEach(function (m) {
	                newSnake = (0, _snake.moveSnakeHead)(newSnake, m);
	                if ((0, _snake.isSnakeHeadAtPosition)(newSnake, newApple)) {
	                    newApple = '';
	                } else {
	                    newSnake = (0, _snake.removeSnakeTail)(newSnake);
	                }
	            });
	            ...
	            getPossibleMoves(newSnakeHead, newGrid, newSnake).forEach(function (possibleMove) {
	                ...
	                newMoves.push(new Uint8Array([].concat(_toConsumableArray(move), [possibleMove])));
	            });
	        });
	    ...
	    var newDiffTime = endTime - startTime;
